...
public class Card {
	...
	public Card categories(Category... categories) {
	...
	public static final Card HOLMES = new Card("Holmes", 50).categories(Category.DETECTIVE);
	public static final Card MYCROFT = new Card("Mycroft", 40).categories(Category.DETECTIVE);
	public static final Card WATSON = new Card("Watson", 30).categories(Category.DETECTIVE, Category.CAN_ALIBI);
	public static final Card VILLAIN_20 = new Card("Charles Augustus Milverton", 20).categories(Category.VILLAIN);
	public static final Card VILLAIN_30 = new Card("John Clay", 30).categories(Category.VILLAIN);
	public static final Card VILLAIN_40 = new Card("Colonel Moran", 40).categories(Category.VILLAIN);
	public static final Card VILLAIN_50 = new Card("Professor Moriarty", 50).categories(Category.VILLAIN);
	...
	public static final Card I_SUSPECT = new Card("I Suspect", 5, "Arrest", "Inspector", "Train", "Hansom").categories(Category.CAN_ALIBI);
	...
	public static final Card INSPECTOR = new Card("Inspector", 15, "Arrest", "Train", "Hansom").categories(Category.CAN_ALIBI);
	public static final Card ARREST = new Card("Arrest", 15, "Train", "Hansom").categories(Category.CAN_ALIBI);
}
